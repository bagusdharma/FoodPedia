                ...
                <div class="row find-img-align">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="{{asset('template/images/find-place2.jpg')}}" class="img-fluid"
                                        alt="img13" />
                                    <figcaption>
                                        <h5>Bandung</h5>
                                        <p>210 Restaurant</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="{{asset('template/images/find-place3.jpg')}} " class="img-fluid"
                                        alt="img13" />
                                    <figcaption>
                                        <h5>Surabaya </h5>
                                        <p>200 Restaurant</p>
                ...
                <div class="row find-img-align">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="{{asset('template/images/find-place4.jpg')}} " class="img-fluid"
                                        alt="img13" />
                                    <figcaption>
                                        <h5>Bali </h5>
                                        <p>90 Restaurant</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="{{asset('template/images/find-place5.jpg')}} " class="img-fluid"
                                        alt="img13" />
                                    <figcaption>
                                        <h5>Sumatera </h5>
                                        <p>79 Restaurant</p>
