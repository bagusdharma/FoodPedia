                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <input type="text" placeholder="New york" class="btn-group2">
                                             <button type="submit" class="btn-form"><span
                                                    class="icon-magnifier search-icon"></span>SEARCH<i class="pe-7s-angle-right"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </div> --}}
                ...
                <div class="row justify-content-center">
                    <div class="col-md-5">
                        <div class="styled-heading">
                            <h3>Restaurants on Indonesia</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="find-place-img_wrap">
                            <div class="grid">
                                <figure class="effect-ruby">
                                    <img src="{{asset('template/images/find-place1.jpg')}}" class="img-fluid" alt="img13" />
                                    <figcaption>
                                        <h5>Jakarta </h5>
                                        <p>298 Restaurant</p>
                                    </figcaption>
                        ...
                        <div class="row find-img-align">
                            <div class="col-md-12">
                                <div class="find-place-img_wrap">
                                    <div class="grid">
                                        <figure class="effect-ruby">
                                            <img src="{{asset('template/images/find-place2.jpg')}}" class="img-fluid" alt="img13" />
                                            <figcaption>
                                                <h5>Bandung</h5>
                                                <p>210 Restaurant</p>
                                            </figcaption>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="find-place-img_wrap">
                                    <div class="grid">
                                        <figure class="effect-ruby">
                                            <img src="{{asset('template/images/find-place3.jpg')}} " class="img-fluid" alt="img13" />
                                            <figcaption>
                                                <h5>Surabaya </h5>
                                                <p>200 Restaurant</p>
                                            </figcaption>
                        ...
                        <div class="row find-img-align">
                            <div class="col-md-12">
                                <div class="find-place-img_wrap">
                                    <div class="grid">
                                        <figure class="effect-ruby">
                                            <img src="{{asset('template/images/find-place4.jpg')}} " class="img-fluid" alt="img13" />
                                            <figcaption>
                                                <h5>Bali </h5>
                                                <p>90 Restaurant</p>
                                            </figcaption>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="find-place-img_wrap">
                                    <div class="grid">
                                        <figure class="effect-ruby">
                                            <img src="{{asset('template/images/find-place5.jpg')}} " class="img-fluid" alt="img13" />
                                            <figcaption>
                                                <h5>Sumatera </h5>
                                                <p>79 Restaurant</p>
                                            </figcaption>
